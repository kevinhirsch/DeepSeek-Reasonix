...
export const zh: Record<DictKey, string> = {
  ...
  // ── 仓库选择器 ──────────────────────────────────────────────────────────────
  "repoPicker.searchPlaceholder": "搜索仓库…",
  "repoPicker.searchLabel": "搜索仓库",
  "repoPicker.noSearchResults": "没有匹配的仓库",
  "repoPicker.noRepos": "没有仓库",
  "repoPicker.connectHint": "连接 GitHub 账号以查看您的仓库",
  "repoPicker.openRepo": "打开仓库",
  "repoPicker.open": "打开",
  "repoPicker.cloneRepo": "克隆仓库",
  "repoPicker.cloning": "克隆中…",
  "repoPicker.clone": "克隆",

  // ── 仓库初始化进度 ──────────────────────────────────────────────────────────
  "repoSetup.settingUp": "正在设置 {name}",
  "repoSetup.stageCloning": "克隆仓库",
  "repoSetup.stageDetecting": "检测项目类型",
  "repoSetup.stageInit": "初始化工作区",
  "repoSetup.stageReady": "就绪",
  "repoSetup.retry": "重试",
  "repoSetup.clonedTo": "已克隆到",

  // ── 后台任务面板 ────────────────────────────────────────────────────────────
  "backgroundTasks.title": "后台任务",
  "backgroundTasks.regionLabel": "后台任务 — {count} 个活跃",
  "backgroundTasks.allCompleted": "所有后台任务已完成",
  "backgroundTasks.activeRunning": "{n} 个后台任务运行中",
  "backgroundTasks.watching": "正在监听任务…",
  "backgroundTasks.empty": "没有后台任务在运行",
  "backgroundTasks.closePanel": "关闭后台任务面板",
  "backgroundTasks.dismissError": "关闭错误",
  "backgroundTasks.taskList": "后台任务列表",
  "backgroundTasks.taskListLabel": "后台任务列表",
  "backgroundTasks.peekAction": "查看 {label}",
  "backgroundTasks.sendAction": "向 {label} 发送消息",
  "backgroundTasks.killAction": "终止 {label}",
  "backgroundTasks.detailsLabel": "{label} 详情",
  "backgroundTasks.status": "状态",
  "backgroundTasks.statusPending": "等待中",
  "backgroundTasks.statusWaiting": "等待中",
  "backgroundTasks.statusRunning": "运行中",
  "backgroundTasks.statusDone": "已完成",
  "backgroundTasks.statusFailed": "失败",
  "backgroundTasks.toolsCalled": "已调工具",
  "backgroundTasks.lastTool": "最近工具",
  "backgroundTasks.started": "已启动",
  "backgroundTasks.startedAgo": "{time} 前",
  "backgroundTasks.worker": "工作节点",
  "backgroundTasks.duration": "耗时",
  "backgroundTasks.durationSeconds": "{n}秒",
  "backgroundTasks.reasoning": "推理",
  "backgroundTasks.remoteLabel": "（远程）",
  "backgroundTasks.remoteWorker": "远程节点",
  "backgroundTasks.runningOn": "运行于 {worker}",
  "backgroundTasks.toolCount": "{n} 个工具",
  "backgroundTasks.toolCountPlural": "{n} 个工具",
  "backgroundTasks.footerStatus": "{active} 活跃，{done} 已完成，{failed} 失败",
  "backgroundTasks.polling": "轮询 {ms}ms",
  "backgroundTasks.hintNavigate": "导航",
  "backgroundTasks.hintPeek": "查看",
  "backgroundTasks.hintSend": "发送",
  "backgroundTasks.hintKill": "终止",
  "backgroundTasks.hintClose": "关闭",

  // ── 远程节点面板 ────────────────────────────────────────────────────────────
  "remotes.title": "远程节点",
  "remotes.addWorker": "添加远程节点",
  "remotes.closePanel": "关闭远程节点面板",
  "remotes.dismissError": "关闭错误",
  "remotes.editForm": "编辑远程节点",
  "remotes.addForm": "添加远程节点",
  "remotes.formName": "名称",
  "remotes.formHost": "主机",
  "remotes.formPort": "端口",
  "remotes.formMaxConcurrent": "最大并发",
  "remotes.formToken": "令牌",
  "remotes.formTls": "TLS 已启用",
  "remotes.formTokenPlaceholder": "认证令牌",
  "remotes.formTokenUnchanged": "（留空则不变）",
  "remotes.save": "保存",
  "remotes.add": "添加",
  "remotes.cancel": "取消",
  "remotes.loadingWorkers": "正在加载节点…",
  "remotes.empty": "未配置远程节点。",
  "remotes.addFirst": "添加第一个节点",
  "remotes.workerList": "远程节点列表",
  "remotes.secure": "安全",
  "remotes.insecure": "不安全",
  "remotes.lastSeen": "上次在线 {time}",
  "remotes.jobsActive": "{active} / {max} 个任务活跃",
  "remotes.capabilities": "能力",
  "remotes.testConnection": "测试到 {name} 的连接",
  "remotes.testOk": "正常",
  "remotes.testFailed": "失败",
  "remotes.testResult": "{status}：{latency}",
  "remotes.edit": "编辑 {name}",
  "remotes.remove": "移除 {name}",
  "remotes.footerOnline": "{online} / {total} 在线",
  "remotes.footerActiveJobs": "{count} 个活跃任务",
  "remotes.connectionFailed": "连接失败",

  // ── 工作流卡片 ──────────────────────────────────────────────────────────────
  "workflow.stageStatusRunning": "运行中",
  "workflow.stageStatusCompleted": "已完成",
  "workflow.stageStatusFailed": "失败",
  "workflow.stageStatusPending": "等待中",
  "workflow.voteMajority": "多数",
  "workflow.voteUnanimous": "一致",
  "workflow.voteWeighted": "加权",
  "workflow.stagesCount": "{n} 个阶段",
  "workflow.statusSummary": "{done} 完成 / {running} 运行中",
  "workflow.statusSummaryFailed": "{done} 完成 / {running} 运行中 / {failed} 失败",
  "workflow.totalSubagents": "子代理总数",
  "workflow.estimatedTokens": "预估 tokens",
  "workflow.stageAgents": "{n} 个代理",
  "workflow.stageTokens": "~{n} tok",
  "workflow.fanOut": "扇出：{n}x",
  "workflow.vote": "投票：{strategy}",

  // ── 推测执行结果卡片 ────────────────────────────────────────────────────────
  "speculative.title": "推测执行",
  "speculative.parallelRuns": "{n} 个并行执行",
  "speculative.confirmed": "已确认",
  "speculative.uncertain": "不确定",
  "speculative.confirmedRuns": "{count}/{total} 次执行",
  "speculative.uncertainRuns": "{count}/{total} 次执行",
  "speculative.totalCost": "总计：${cost}",
  "speculative.vsSingle": "对比单次：${cost}",
  "speculative.totalTokens": "共 {n} tok",
  "speculative.confirmedTitle": "已确认的执行",
  "speculative.uncertainTitle": "未确认的执行",
  "speculative.inConsensus": "{count}/{total} 达成共识",
  "speculative.needReview": "{count}/{total} 需要审查",
  "speculative.verdictConfirmed": "已确认",
  "speculative.verdictPlausible": "合理",
  "speculative.verdictRefuted": "已驳回",
  "speculative.verdictUncertain": "不确定",
  "speculative.inConsensusBadge": "已达成共识",
  "speculative.confidence": "{n}% 置信度",

  // ── 投票明细 ────────────────────────────────────────────────────────────────
  "voting.title": "投票明细",
  "voting.totalVotes": "共 {n} 票",
  "voting.thresholdType": "{type} 阈值",
  "voting.thresholdLabel": "阈值：{count} 票（{pct}%）",
  "voting.passed": "已通过",
  "voting.notMet": "未达标",
  "voting.noVotes": "无投票记录",
  "voting.votes": "{n} 票",
  "voting.legendThreshold": "阈值",
  "voting.majority": "多数",
  "voting.unanimous": "一致",

  // ── 工作流面板 ──────────────────────────────────────────────────────────────
  "workflowPanel.tabWorkflow": "工作流",
  "workflowPanel.tabSpeculative": "推测",
  "workflowPanel.tabVoting": "投票",
  "workflowPanel.autoRefresh": "自动刷新",
  "workflowPanel.noActiveWorkflow": "无活跃工作流",
  "workflowPanel.emptyDescription":
    "启动一个带有扇出和投票的多代理工作流，即可在此查看进度、推测结果和投票明细。",
  "workflowPanel.press": "按",
  "workflowPanel.toOpen": "打开",
  "workflowPanel.noWorkflowData": "没有可用的工作流数据",
  "workflowPanel.noSpeculativeData": "暂无推测结果",
  "workflowPanel.noVotingData": "暂无投票数据",
};
